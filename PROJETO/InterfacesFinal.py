    ...
    def procurar_autores(bd):
        ...
        if lista:
            ...
            if salvar == 's':
                ...
                fpj.salvar_em_arquivo(lista, nome_arquivo)
            else:
                print("Operação cancelada.")
        else:
    ...
    def listaAutores(bd):
        ...
        if lista_ordenada:
            ...
            if salvar == 's':
                ...
                fpj.salvar_em_arquivo(lista_ordenada, nome_arquivo)
            else:
                print("Operação cancelada.")
        else:
    ...
    def distrib_ano(bd):
        ...
        if d:
            ...
            if salvar == 's':
                ...
                fpj.salvar_em_arquivo(dict(lista), nome_arquivo)
